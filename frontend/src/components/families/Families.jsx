...
import { Users, User, Quote, Phone, Home } from "lucide-react";
        ...
        <header className="families-slim-hero">
          ...
          >
            ...
            <h1 className="slim-title">
              OUR <span className="highlight">FAMILIES</span>
            </h1>
          </motion.div>
        </header>
          ...
          <AnimatePresence>
            ...
            {families.length > 0 ? (
              ...
              families.map((family, index) => {
                ...
                const familyId = family.familyId || index;
                const isExpanded = expandedIds.includes(familyId);

                const displayText = isExpanded
                  ? family.description
                  : family.description
                  ? family.description.slice(0, 120) + (family.description.length > 120 ? "..." : "")
                  : "A unit of the MMUSDA community dedicated to spiritual growth, mutual support, and shared Christian values.";
                    ...
                    <div className="family-details">
                      <div className="details-inner">
                        ...
                        <div className="details-top">
                          <span className="index-tag">FAMILY {String(index + 1).padStart(2, "0")}</span>
                        ...
                        {family.description && family.description.length > 120 && (
                          <button
                            className="read-more-btn"
                            onClick={() => toggleReadMore(familyId)}
                          >
